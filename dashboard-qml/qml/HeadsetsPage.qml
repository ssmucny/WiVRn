...
Kirigami.ScrollablePage {
		...
		Kirigami.Card {
			...
			contentItem: GridLayout {
				...
				Controls.Button {
					...
					onClicked: WivrnServer.revoke_key(publicKey)
				}
			}
		}
	}
	...
	Kirigami.CardsListView {
		...
		Kirigami.PlaceholderMessage {
			...
			text: WivrnServer.pairingEnabled
				? i18n("Start the WiVRn app on your headset and use the PIN: %1", WivrnServer.pin)
				: i18n("Enable pairing to allow your headset to connect to this computer");
			// explanation: ""
